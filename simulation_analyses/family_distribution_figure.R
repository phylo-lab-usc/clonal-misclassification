...
CO_1 <- transform(CO_1, name = colsplit(sequence_id, pattern = "\\_", names = c('fam', 'sim', 'seq')))
...
CO_2 <- transform(CO_2, name = colsplit(sequence_id, pattern = "\\_", names = c('fam', 'sim', 'seq')))
...
CO_3 <- transform(CO_3, name = colsplit(sequence_id, pattern = "\\_", names = c('fam', 'sim', 'seq')))
...
CO_4 <- transform(CO_4, name = colsplit(sequence_id, pattern = "\\_", names = c('fam', 'sim', 'seq')))
